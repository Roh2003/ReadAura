  ...
  return (
    <main className="min-h-screen bg-slate-950 text-slate-200 py-12 px-4 md:px-8">
      <div className="max-w-6xl mx-auto space-y-16">
        ...
        >
          <h1 className="text-4xl md:text-5xl font-bold text-white">About ReadAura</h1>
          ...
          <div className="flex flex-col md:flex-row items-center gap-12">
            <motion.div className="md:w-1/2 space-y-6" variants={itemVariants}>
              ...
              <p className="text-slate-400">
                At ReadAura, we believe that the right book can change your life. Our mission is to connect readers with
        ...
        >
          ...
          <motion.p className="text-slate-400 text-center max-w-3xl mx-auto" variants={itemVariants}>
            ReadAura is built by a passionate team of book lovers, developers, and data scientists who are committed to
          ...
          <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
            ...
            >
              ...
              <h3 className="text-xl font-semibold text-white mb-1">Pratish Bhongle</h3>
            ...
            >
              ...
              <h3 className="text-xl font-semibold text-white mb-1">Ritika Mishra</h3>
          ...
          >
            <div className="text-center space-y-4">
              <p className="text-white">
                Email us at: <span className="text-purple-400">contact@readaura.com</span>
              </p>
