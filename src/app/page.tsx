          ...
          <div className="max-w-4xl mx-auto text-center">
            <motion.div initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }} transition={{ duration: 0.8 }}>
              ...
              <div className="flex flex-wrap justify-center gap-4">
                <Button size="lg" className="bg-white text-[#050A1A] hover:bg-gray-200 px-8 py-6 text-lg">
      ...
      <section className="py-20 relative overflow-hidden">
        ...
        <div className="container mx-auto px-4 relative z-10">
          <div className="text-center mb-16">
            <h2 className="text-3xl md:text-4xl font-bold mb-4">How ReadAura Works</h2>
            <p className="text-gray-400 max-w-2xl mx-auto">
      ...
      <section className="py-16 bg-[#060B1D] overflow-hidden">
        <div className="container mx-auto px-4">
          <div className="text-center mb-12">
            ...
            <p className="text-gray-400 max-w-2xl mx-auto">
              Discover how ReadAura has transformed reading experiences for our community
            </p>
          </div>
          ...
          <div className="max-w-3xl mx-auto text-center">
            ...
            >
              ...
              <p className="text-xl mb-8 text-gray-300 max-w-2xl mx-auto">
                Join thousands of readers who have discovered their perfect literary matches with ReadAura.
              </p>
              <div className="flex flex-wrap justify-center gap-4">
